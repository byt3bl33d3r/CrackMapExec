...
class CMEModule:
    ...
    def run_lsassy(self, context, connection):  # copied and pasted from lsassy_dumper
    ...
    def on_admin_login(self, context, connection):
        ...
        dbconnection = connect(db_path, check_same_thread=False,
                               isolation_level=None)  # Sqlite DB will be saved at ./CrackMapExec/default if name in cme.conf is default
